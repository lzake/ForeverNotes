...
export default class Notes extends Component {
    ...
    async componentDidMount() {
        try {
            ...
            this.setState({note: results, content: results.content});
        } catch (e) {
            console.log(e)
            alert(e);
        }
    ...
    saveNote(note) {
        return invokeApig({path: `/notes/${this.props.match.params.id}`, method: "PUT", body: note});
    }
    ...
    deleteNote() {
        return invokeApig({path: `/notes/${this.props.match.params.id}`, method: "DELETE"});
    }
        ...
        return (
            <div className="Notes">
                {this.state.note && <form onSubmit={this.handleSubmit}>
                    ...
                    {this.state.note.attachment && <FormGroup>
